                        ...
                        @forelse ($passkeys as $passkey)
                            <div class="flex items-center justify-between p-4 {{ ! $loop->last ? 'border-b border-zinc-200 dark:border-zinc-700' : '' }}">
                                ...
                                <flux:button
                                    ...
                                    class="text-brand-danger hover:text-brand-danger hover:bg-brand-danger/10 dark:hover:bg-brand-danger/20"
                                />
                            </div>
                        @empty
    ...
    >
        <div class="space-y-6">
            ...
            <div class="flex gap-3 justify-end">
                ...
                <flux:button
                    variant="outline"
                    class="border-brand-danger-border! text-brand-danger! hover:bg-brand-danger-hover-bg!"
