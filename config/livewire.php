...
return [
    ...
    */
    ...
    |
    | 'rules' explicitement fixé (au lieu du défaut vendor, null => 12 Mo) :
    | ScanPremier valide déjà `document` à 20 Mo (voir ScanPremier::RESOLUTION_MINIMALE
    | et sa règle 'max:20480') — sans ce réglage, un fichier de 13-19 Mo échouait
    | TOUJOURS avant même d'atteindre cette règle, rejeté plus tôt par la limite
    | par défaut de Livewire lui-même. Bug préexistant au scan manuel, corrigé
    | ici à l'occasion de l'ajout du dossier surveillé (2026-09-09), qui l'aurait
    | rendu bien plus visible en boucle automatique.
    |
    */

    'temporary_file_upload' => [
        'disk' => env('LIVEWIRE_TEMPORARY_FILE_UPLOAD_DISK'), // Example: 'local', 's3'             | Default: 'default'
        'rules' => ['required', 'file', 'max:20480'],         // Aligné sur ScanPremier (20 Mo)
